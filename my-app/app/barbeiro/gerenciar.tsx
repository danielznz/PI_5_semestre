...
import { db, auth } from "../lib/firebaseConfig"; // 🔥 importando auth também
...
export default function GerenciarServicos() {
  ...
  // 🔹 Buscar apenas serviços do barbeiro logado
  const carregarServicos = async () => {
    try {
      ...
      const q = query(collection(db, "servicos"), where("barbeiroUid", "==", user.uid));
